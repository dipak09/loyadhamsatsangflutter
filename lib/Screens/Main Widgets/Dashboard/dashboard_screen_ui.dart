...
class _DashboardScreenUIState extends State<DashboardScreenUI> {
  ...
  Widget liveStreamSection() {
    return Home.livestreamingList.length == 0 &&
                    ...
                    onTap: () {
                      Get.to(() =>
                          FeaturedMediaVideoID(
                            ...
                            publishedDate: Home.featureMediaList[index].publishedDate,
                        ...
                        children: [
                          Container(
                              ...
                              child: ClipRRect(
                                  ...
                                  child: CachedImageWithShimmer(
                                      fit: BoxFit.fitHeight,
                                      imageUrl: Home.featureMediaList[index].thumbnail!))),
                          Container(
                              margin: EdgeInsets.symmetric(
                                  horizontal: 10),
                              width: 250,
                              ...
                              child: Column(children: [
                                Container(
                                    ...
                                    width: 250,
                                    child: CustomText(
                                        Home.featureMediaList[index].title!,
                                        fontSize: 9,
                                        overflow:
                    ...
                    child: ListTile(
                      ...
                      leading: Container(
                        ...
                        child: Home.todayBhajanEventList[index]
                            ...
                            "https://cdn.crispedge.com/a7aeb4.png",)
                            : Image.network(Home
                            .todayBhajanEventList[index].icon
